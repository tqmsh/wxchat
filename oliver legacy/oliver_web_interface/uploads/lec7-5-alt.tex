...
% \end{itemize}
% \item Next class, we will discuss the resolving virtual memory problems.
...
%%% beginning of conitnued lecture on VM
% for comprehensive
\newpage
...
\begin{figure}[H]
\centering
	{\includegraphics[width=0.8\textwidth]{06-memory-hierarchies/figures/tlb-cache-no-memory-access-anno.png}}
\end{figure}
...
% \begin{frame}[fragile]\frametitle{Virutal Memory: TLB and Cache}
% Reading from the TLB and cache avoids reading from memory.
% \begin{figure}[H]
% \centering
...
\begin{frame}[fragile]
\Title{In a snapshot: VM and Multitasking}
\begin{itemize}
...
% ///additional slides
%% ZHK note already incldued in lecture 1 on VM 
% \begin{frame}[fragile]
% \Title{More on Page Tables}
% % \begin{itemize}
% % \item Page replacement policies:
